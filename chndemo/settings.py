"""
Django settings for chndemo project.
"""
...
DATATYPE_LOCATIONS.append('chndemo.datatypes')
FUNCTION_LOCATIONS.append('chndemo.functions')
SEARCH_COMPONENT_LOCATIONS.append('chndemo.search_components')
...
SECRET_KEY = 'l0oq2f%worti9)7+cy**j%v(4w#6!p_!zu4#tn@ph56n(%xk54'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'chndemo.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'chndemo'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'chndemo.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'chndemo.wsgi.application'
